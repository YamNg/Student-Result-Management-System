package com.shyftlabsinterview.assessment.constant;
...
public class ErrorCode {
    ...
    // 2. Data Errors -> Error thrown when saving to database, which is expected behavior (e.g. violation of Result unique index)
